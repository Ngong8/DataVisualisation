import tkinter
import sys
# This custom button for TKinter implemented by Tom Schimansky
# His github repo for custom button: https://github.com/TomSchimansky/GuitarTuner/tree/master/documentation
